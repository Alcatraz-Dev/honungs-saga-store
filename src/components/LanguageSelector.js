...
// Define the options with country codes
const localeOptions = {
  AR: 'Arabic',
  GB: 'English',
  SE: 'Swedish',
...
const LanguageSelector = () => {
  ...
  // Handle the flag selection change
  const handleSelect = (countryCode) => {
    const language = countryCode.toLowerCase();
    changeLanguage(language);  // Change language in context
  ...
  return (
    <div className="w-24 flex justify-center items-center">
      <FlagSelect
        countries={['GB', 'AR', 'SE']} // List of countries/flags you want to display
        customLabels={localeOptions} // Custom labels for each flag
        onSelect={handleSelect} // Function to handle country code selection
        defaultCountry={language.toUpperCase()} // Default flag based on the language
